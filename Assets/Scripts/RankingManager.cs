...
public class RankingManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        scroll=objRanking.GetComponentInChildren<ScrollRect>();//GetComponentInChildren 에서 s가 붙어 자식들을 찾냐 1개만 찾냐 차이가있다.
    ...
    private void setRankingData()
    {
        ...
        for (int iNum = 0; iNum < rankCount; ++iNum)
        {
            ...
            sc.SetRanking((iNum + 1).ToString("D2"),
